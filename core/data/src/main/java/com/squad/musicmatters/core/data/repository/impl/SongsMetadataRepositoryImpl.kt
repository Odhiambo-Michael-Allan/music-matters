...
class SongsMetadataRepositoryImpl @Inject constructor(
    ...
    private val metadataFlow: StateFlow<MetadataResult> = songsRepository.fetchSongs()
        .map { songs ->
            ...
            MetadataResult.Success( songs.mapNotNull { metadataCache[ it.id ] } )
        }.stateIn(
            scope = coroutineScope, // Runs safely on Dispatchers.IO
            started = SharingStarted.WhileSubscribed( 5_000 ),
            initialValue = MetadataResult.Loading
        )
