...
object ThemeColors {
    ...
    val PrimaryColorsMap = mapOf(
        PrimaryThemeColors.Red to GoogleRed,
        PrimaryThemeColors.Orange to Orange,
        PrimaryThemeColors.Amber to Amber,
        PrimaryThemeColors.Yellow to GoogleYellow,
        PrimaryThemeColors.Lime to Lime,
        PrimaryThemeColors.Green to GoogleGreen,
        ...
        PrimaryThemeColors.Blue to GoogleBlue,
